<!-- View stored in resources/views/admin/sub-attendance-report/list.blade.php -->

@extends('admin.layouts.layout')
@section('content')
    @php
        $action = isset($user)
                ? "/admin/users/{$user->id}/sub-attendance-reports"
                : "/admin/sub-attendance-reports";
    @endphp
    <div class="container">
        @if (isset($user))
            <div class="row">
    ...
    <script>
        $('#formModal').on('show.bs.modal', (e) => {
            ...
            const url = '/admin/sub-attendance-reports/' + id;
            $('#id').val(id);
            $('#layer').val(layer);
