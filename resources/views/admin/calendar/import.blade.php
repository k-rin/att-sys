<!-- View stored in resources/views/admin/calendar/import.blade.php -->

@extends('admin.layouts.layout')
@section('content')
    <div class="container w-75 p-5 ms-1">
        <div id="uploadStatus"></div>
            <p class="fs-6 mb-4"><a href="https://data.gov.tw/dataset/14718">中華民國政府行政機關辦公日曆表</a>からダウンロードしてください。</p>
    ...
    <script>
        $(() => {
            ...
            $('#uploadForm').on('submit', (e) => {
                ...
                axios
                .post('/admin/calendar/import', form, config)
                .then(() => {
                    $('#uploadForm')[0].reset();
